...
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/rudigpobot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="Bot Rudi dibuat untuk membantu Bot Lisa mengelola grup."),
     ],
    [
...
DONATE_STRING = """Heya, senang mendengar Anda ingin menyumbang!
 Anda dapat mendukung proyek dengan menghubungi @jailanihayyan \
 Mendukung tidak selalu finansial! \
 Mereka yang tidak dapat memberikan dukungan keuangan dipersilakan untuk membantu kami mengembangkan bot."""
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Rudigpobot.modules." + module_name)
